...
/**
 * Purpose: Provide a screen to create a new meeting to display the new meeting code
 */
export default class NewMeetingScreen extends React.Component {
  ...
  /**
   * Purpose: Render the new meeting screen
   */
  render() {
  ...
  /**
   * Purpose: Proceed to the meeting dialog screen
   */
  _onPressOkay = () => {
  ...
  /**
   * Purpose: Override the hardware back button functionality
   */
  _onPressBackButton = () => {
...
/**
 * Purpose: Provide styles for the new meeting screen
 */
